  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="signup-email" className="text-xs font-semibold tracking-wide text-cool-gray/80">
          Email
        </label>
        <input
          id="signup-email"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="signup-password" className="text-xs font-semibold tracking-wide text-cool-gray/80">
          Password
        </label>
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="signup-confirm" className="text-xs font-semibold tracking-wide text-cool-gray/80">
          Confirm password
        </label>
        <input
          id="signup-confirm"
          ...
          disabled={loading}
          className={`w-full rounded-xl border bg-surface px-4 py-3 text-sm text-glacier-white placeholder:text-cool-gray/40 transition-all duration-200 focus:outline-none focus:ring-[2.5px] focus:ring-signal-blue/60 disabled:opacity-50 ${
            errors.confirm ? 'border-crisis-red/30' : 'border-white/[0.07]'
          }`}
        />
        {errors.confirm && (
      ...
      <p className="text-xs text-cool-gray/50 leading-relaxed">
