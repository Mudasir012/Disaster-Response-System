...
export default function AISummaryCard({ summary, confidence, sourceCount, showAdmin = false }) {
  return (
    <div className="bg-[#1a1040] border border-ai-purple/30 rounded-xl p-5 border-l-4 border-l-ai-purple">
      ...
      <div className="flex items-center gap-4 mt-3 text-xs text-cool-gray/60">
        <span>Generated by Claude AI from {sourceCount} sources</span>
        {confidence && (
          <div className="flex items-center gap-1.5">
