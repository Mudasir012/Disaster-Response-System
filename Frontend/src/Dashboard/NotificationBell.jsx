  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full bg-crisis-red text-[8px] font-bold text-on-accent flex items-center justify-center">
            {unread > 9 ? '9+' : unread}
          </span>
        )}
      </button>
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-10 z-40 w-80 bg-surface/95 backdrop-blur-xl border border-[oklch(0.26_0.022_255/0.08)] rounded-xl shadow-[0_16px_48px_-12px_rgba(15,23,42,0.22)] overflow-hidden">
