...
export default class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <div className="h-[100dvh] w-full bg-landing-bg flex items-center justify-center p-8">
          <div className="max-w-md text-center">
            <div className="w-10 h-10 mx-auto mb-4 rounded-full bg-red-500/20 flex items-center justify-center">
              <span className="text-red-600 text-lg font-bold">!</span>
            </div>
            <p className="text-sm text-red-600 font-mono mb-2">Component error</p>
            <p className="text-[11px] text-cool-gray/70 font-mono leading-relaxed break-all">
